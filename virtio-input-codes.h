...
/*
 * Relative axis identifiers (used for pointer motion and scroll reporting)
 *
 * REL_X / REL_Y are standard evdev mouse deltas. REL_WHEEL positive = scroll
 * up, REL_HWHEEL positive = scroll right.
 */
 ...
 * from driver to device via VIRTIO_INPUT_STATUSQ)
 */
